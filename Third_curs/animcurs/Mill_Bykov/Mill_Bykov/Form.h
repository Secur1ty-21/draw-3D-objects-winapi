...
public:
	...
	void OnText(TCHAR* char_, size_t lenght);
...
/*
* Add new value (max == 10)
* Добавить новое значение (максимально 10)
*/
...
void DrawTruss(HWND hWnd, LPPAINTSTRUCT lpPS);
